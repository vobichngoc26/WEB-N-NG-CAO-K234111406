...
import { AshionDetailComponent } from './ashion-detail-component/ashion-detail-component';
...
const routes: Routes = [
  ...
  {path: 'ex61', component: Login},
  {path: 'dangki', component: Register},
  {path: 'ex54', component: AshionDetailComponent},
  {path: 'ex63', component: CartComponent},
  {path: 'ex63-product', component: ProductCart},
