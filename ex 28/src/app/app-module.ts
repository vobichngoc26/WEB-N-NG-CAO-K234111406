...
@NgModule({
  declarations: [App, About, Notfound, Listproduct, Productdetail, ServiceProductImageEvent, ProductComponent, Listcustomers, FakeProductComponent, FakeProduct2, Ticker],
  imports: [
    BrowserModule,
    CommonModule,
    FormsModule,
